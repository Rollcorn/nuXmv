// Generated from /home/denis/Documents/5_ITMO/NIR/nuXmv/src/main/java/org/shkandyuk/nuxmv/grammar/parser/NuXmvLexer.g4 by ANTLR 4.13.1
...
public class NuXmvLexer extends Lexer {
	...
	public static final int
		...
		BOOLEAN=43, BR=44, BAD_CHARACTER=45;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MODULE", "IVAR", "SEMI", "SEMICOLON", "VAR", "ASSIGN", "INIT", "L_BRACKET", 
			"R_BRACKET", "TRANS", "INVAR", "INIT_ASSIGN", "ASSIGN_OP", "EXCLAMATION_EQ", 
			"L_ARROW_EQ", "R_ARROW_EQ", "L_ARROW", "R_ARROW", "EQ", "NEXT_ASSIGN", 
			"CASE", "ESAC", "BIT_OR", "COND_EXPR", "BIT_AND", "EXCLAMATION", "TRUE", 
			"FALSE", "REAL", "L_BRACE", "R_BRACE", "COMMA", "ID", "NUMBER", "X", 
			"G", "F", "U", "WS", "COMMENT", "LINE_COMMENT", "STRING", "BOOLEAN", 
			"BR", "BAD_CHARACTER"
		};
	}
	...
	public NuXmvLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "NuXmvLexer.g4"; }
